...
module.exports = class VisualService {
    ...
    init() {
        ...
        for (var b = 0; b < this.height; b++) {
            process.stdout.write(this.background + this.fill("", this.width) + "\x1b[0m" + EOL)
        }
    }
    done() {
        this.fillscreen()
    ...
    update() {
        ...
        var n = this.background + this.fill("", this.width) + EOL
        for (var b = 0; b < this.height - 1; b++) {
            if (!this.visible[b]) {

                process.stdout.write('\x1b[0m' + n)
            } else {
                process.stdout.write('\x1b[0m' + this.background + this.visible[b] + EOL)
            }
        }
    }
    ...
    fillscreen() {
        ...
        for (var b = 0; b < this.height; b++) {
            process.stdout.write(this.background + this.fill("", this.width) + EOL)
        }
